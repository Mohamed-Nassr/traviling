...
$obj->DELETComm($_POST['commentid']);
 ...
 else if(isset($_POST['edit']))
 {
   ...
   $destination=$_POST['deist'];
    ...
    $days=$_POST['days'];
    $obj->editspecial($_SESSION['email'],$_POST['nomber'],$destination,$passenger,$days);
 }
 else if (isset($_POST['delete']))
 {
    $obj->canclespecialJou($_POST['nomber'],$_SESSION['email']);
 }
                            ...
                            <div class="navbar">
                                ...
                                <div class="navbar-collapse collapse">
                                    <ul class="nav navbar-nav navbar-right">
                                        <li class="act1ive"><a class="smoth-scroll" href="Home.php">Home <div class="ripple-wrapper"></div></a>
                                        </li>
    ...
    <section id="portfolio" class="portfolio section-space-padding">
        <div class="container">
            <div class="row">
                ...
                $db = new database();
                  $ss=$_SESSION['email'];
                    $query1="SELECT * FROM customer WHERE email='$ss'";
                      $row= array();
                     $result1=  mysqli_query($db->link, $query1);
                      ...
                      $id=$row['id'];
                    $query="SELECT COUNT(id) FROM special WHERE cu='$id'";
                    $result=  mysqli_query($db->link, $query);

                    $query3="SELECT * FROM special WHERE cu='$id'";
                      $row3= array();
                  ...
                  echo '              
                   <div class="di">
                      ...
                      <form act1ion="#" method="POST">
                       <input class="add-jou" name="deist" type="text"  placeholder="Destination">
                         

                           
                           <br>

                           <h1>'. $row['no_of_passenger'] .' </h1>
                         
                          <input class="add-jou" name="number" type="number_format"  placeholder="Number Of Passenger">
                          
                          <br>


                          <h1>'. $row['no_of_days'] .'</h1>
                          
                       <input class="add-jou" type="text" name="days"   placeholder="Number Of Days">
                       ...
                       <br>
                        ...
                        <input class="delete" name="edit" type="submit"  value="Edit">
                        </form>
...
-                               <input class="delete" value="'.$row['id'].'" name="nomber" type="hidden" >
                    ...
                    <?php
                    $ss=$_SESSION['email'];
                      $q_cust = "SELECT * FROM customer Where email = '$ss'" ;
