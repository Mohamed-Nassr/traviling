  ...
  <body>
    ...
    <section id="about" class="about-section">
         <div class="row">
              ...
              <div class="col-md-6 col-sm-12 col-xs-12">
                <img class="img-responsive" src="photo.jpg" draggable="false" alt="">
              </div>
    ...
    <section id="portfolio" class="portfolio section-space-padding">
        <div class="container">
            ...
            <div class="row">
                <ul class="portfolio">
                    <li class="filter" data-filter=".mockups"><a href="internal.php">Internal</a></li>
                    <li class="filter" data-filter=".mockups"><a href="extrnal.php">Extrnal</a></li>
                </ul>
            </div>
            ...
            <div class="portfolio-inner">
                ...
                $db = new database();
                    ...
                    $query="SELECT COUNT(id) FROM journey WHERE type='7g'";
                    $result=  mysqli_query($db->link, $query);

                    $query3="SELECT * FROM journey WHERE type='7g'";
                      $row3= array();
