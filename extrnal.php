      ...
      <div class="container">
            ...
            <div class="row">
                <ul class="portfolio">
                    ...
                    <li class="filter" data-filter=".mockups"><a href="7g.php">حج و عمره</a></li>
                </ul>
            </div>
            ...
            <div class="portfolio-inner">
                ...
                $db = new database();
                    ...
                    $query="SELECT COUNT(id) FROM journey WHERE type='External'";
                    $result=  mysqli_query($db->link, $query);

                    $query3="SELECT * FROM journey WHERE type='External'";
                      $row3= array();
